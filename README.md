...
**kokoroi-rs** 是 [Kokoro](https://github.com/hexgrad/kokoro) 的 Rust 实现，专注于高质量的中文语音合成（Text-to-Speech）。基于 Kokoro 模型，使用 ONNX Runtime 进行推理，提供 CLI 工具和 HTTP API 服务两种使用方式。
